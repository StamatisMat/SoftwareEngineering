    ...
    public static void setVolume(float level)
    {
        ...
        for(Line line : speakers)
        {
            try
            {
                ...
                System.out.println("lemao2: "+control.getValue());
            }
            catch (LineUnavailableException e) { System.out.println("lemao3: ");continue; }
            catch(java.lang.IllegalArgumentException e) {System.out.println("lemao4: "); continue; }
